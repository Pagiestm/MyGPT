<template>
    ...
    >
        <div class="flex-1 group">
            ...
            <h1
                v-if="!isEditing"
                class="font-semibold text-xl text-gray-800 flex items-center"
            >
                {{ title }}
                <button
            ...
            <div v-else class="relative inline-block">
                <input
                    ...
                    class="w-48 px-2 py-1 text-lg font-medium bg-white rounded-lg border-0 border-b-2 border-indigo-300 shadow-sm focus:border-indigo-500 focus:ring-0 transition-all duration-200 focus:w-56"
