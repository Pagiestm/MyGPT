<template>
    ...
    <footer class="bg-gray-900 text-gray-400">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            >
                <div>
                    <div class="text-white font-bold text-2xl mb-4">MyGPT</div>
                    <p class="mb-4">
                        Votre assistant IA personnel pour des conversations plus
                        intelligentes.
                    </p>
            ...
            >
                <p>&copy; {{ currentYear }} MyGPT. Tous droits réservés.</p>
                <p class="mt-4 md:mt-0">Conçu avec ❤️ en France</p>
            </div>
        </div>
    </footer>
</template>
